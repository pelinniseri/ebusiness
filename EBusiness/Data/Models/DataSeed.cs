...
namespace EBusiness.Data.Models
{
    ...
    {
        public static bool seedCategories()
        {
            ...
            if (context.Database.GetPendingMigrations().Count() != 0)
            {
                ...
                {
                    System.Diagnostics.Trace.WriteLine("couldn't save changes");
        ...
        public static bool seedProducts()
        {
            var context = new Context();
        ...
        private static Product[] My_Products()
        {
            ...
            new Product()
            {
                ...
                ImageUrl = "",
                Stock = 9,
                Category = context.Categories.Single<Category>(C =>
                C.CategoryName=="Mobil")
            },
            new Product()
            {
